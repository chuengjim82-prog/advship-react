  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/basic/bankAccountO', icon: 'FileTextOutlined', label: t('menu.bankAccountO'), path: '/basic/bankAccountO' },
        { key: '/basic/bankAccountT', icon: 'FileTextOutlined', label: t('menu.bankAccountT'), path: '/basic/bankAccountT' },
      ],
    },
    {
      key: 'partner',
