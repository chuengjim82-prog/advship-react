...
export default function Customer() {
  ...
  const columns: ColumnDef<CustomerData>[] = [
    ...
    { accessorKey: 'cityName', header: '所在城市', size: 120 },
      ...
      <>
        ...
        <div className="col-span-2">
          ...
          <div className="flex items-center justify-between mb-3">
            <h4 className="font-semibold">客户收件人</h4>
          ...
          <div className="border rounded-md">
            <Table>
              ...
              <TableBody>
                {recipients.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={4} className="text-center text-muted-foreground">暂无收件人</TableCell>
                  </TableRow>
                ) : (
        ...
        <div className="col-span-2">
          <Separator className="my-4" />
          <div className="flex items-center justify-between mb-3">
            <h4 className="font-semibold">客户发件人</h4>
          ...
          <div className="border rounded-md">
            <Table>
              ...
              <TableBody>
                {senders.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={4} className="text-center text-muted-foreground">暂无发件人</TableCell>
                  </TableRow>
                ) : (
        ...
        <div className="col-span-2">
          <Separator className="my-4" />
          <div className="flex items-center justify-between mb-3">
            <h4 className="font-semibold">客户收货地址</h4>
          ...
          <div className="border rounded-md">
            <Table>
              ...
              <TableBody>
                {addresses.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={5} className="text-center text-muted-foreground">暂无收货地址</TableCell>
                  </TableRow>
                ) : (
