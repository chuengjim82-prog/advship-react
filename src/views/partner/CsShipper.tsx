...
const csShipperSchema = z.object({
...
export default function City() {
  ...
  const formRef = useRef<UseFormReturn<CsShipperData> | null>(null)
  ...
  const columns: ColumnDef<CsShipperData>[] = [
  ...
  const defaultValues: CsShipperData = {
    statusi: 1,
    statuss: '',
    contact: '',
    phone: '',
  ...
  return (
    <>
      <CrudTableV2<CsShipperData>
        title="客户发件人"
        apiUrl="/base/api/csShipper"
        columns={columns}
        formSchema={csShipperSchema}
